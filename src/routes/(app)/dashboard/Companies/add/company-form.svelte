<script lang="ts" context="module">
	...
	export const accountFormSchema = z.object({
		...
		}).max(255,"Address must not be longer than 255 characters."),
...
<form method="POST" class="space-y-8" use:enhance>
	...
	<Form.Field name="companynumber" {form}>
		<Form.Control let:attrs>
			...
			<Input {...attrs} bind:value={$formData.companynumber} />
		</Form.Control>
		<Form.FieldErrors />
	</Form.Field>
	<Form.Field name="licensenumber" {form}>
		<Form.Control let:attrs>
			...
			<Input {...attrs} bind:value={$formData.licensenumber} />
		</Form.Control>
		<Form.FieldErrors />
	</Form.Field>
	...
	<Form.Button>Add Company</Form.Button>
</form>
