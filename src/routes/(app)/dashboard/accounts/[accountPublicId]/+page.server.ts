...
export const load = async (event) => {
  ...
  // console.log(event.params,await db.query.Accounts.findFirst({
...
const leaveAccount: Action = async (event) => {
  ...
  redirect('/dashboard/accounts', { type: 'success', message: m.accounts.leave.success }, event);
};
...
const deleteAccount: Action = async (event) => {
  ...
  if (accountId) {
    ...
    redirect('/dashboard/accounts', { type: 'success', message: m.accounts.delete.success }, event);
  }
};
